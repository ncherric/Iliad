rule get_clean_rsids_from_MyData:
	...
	output:
		cleanDBSNPmyData="data/vcf_Merge-and-Lift/{project}/{refAssemblyVersion}/step6A-clean-vcfIDs37/cleaned.{vcf37}.vcf.gz",
		cleanDBSNPmyDataIndex="data/vcf_Merge-and-Lift/{project}/{refAssemblyVersion}/step6A-clean-vcfIDs37/cleaned.{vcf37}.vcf.gz.tbi",
	resources:
		mem_mb=1500,
		runtime="12:00:00",
	benchmark:
