...
shell(
	"mkdir -p data/vcf_Lift-and-Merge/{project}/{refAssemblyVersion}/step3B-InputVCFs-37/"
)
...
shell(
	...
	" -O v"
	" -o data/vcf_Lift-and-Merge/{project}/{refAssemblyVersion}/step3B-InputVCFs-37/tmp.file.txt"
	" {dbsnpDir}{dbsnpFile}"
)

shell(
	" awk '/^[^#]/ {{print $1,$2,$3}}' OFS='\t' data/vcf_Lift-and-Merge/{project}/{refAssemblyVersion}/step3B-InputVCFs-37/tmp.file.txt >"
